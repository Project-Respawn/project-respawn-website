<template>
  <main class="creator-profile-page">
    ...
    <section class="creator-profile-workspace">
        ...
        >
          ...
          <div class="identity-grid">
            ...
            <div class="avatar-column">
              ...
              <p class="field-help">
                Temporary frontend field. Backend image upload can replace this later.
              </p>
            </div>
        ...
        >
          <div class="profile-panel-heading">
            ...
            <div>
              ...
              <p>
                Choose up to five Project Respawn categories that best describe your content.
              </p>
            </div>

            <span class="category-count">
              {{ profile.categories.length }}/{{ categoryLimit }} selected
            </span>
          ...
          <div class="profile-field">
            ...
            <div class="category-grid">
              ...
              <button
                ...
                :class="{
                  selected: profile.categories.includes(category.key),
                  disabled:
                    !profile.categories.includes(category.key) &&
                    profile.categories.length >= categoryLimit
                }"
                :style="{
                  '--category-accent': category.accent,
                  '--category-accent-rgb': category.accentRgb
                }"
                :disabled="
                  !profile.categories.includes(category.key) &&
                  profile.categories.length >= categoryLimit
              ...
              >
                ...
                <span
                  v-if="profile.categories.includes(category.key)"
            ...
            <p class="field-help category-help">
              Project Respawn categories are shared across creator discovery,
              analytics and recommendations so the platform remains consistent.
            </p>
          </div>


          <div class="profile-field games-section">
            ...
            <p class="field-help">
              Game selection will be connected to the Project Respawn IGDB integration.
            </p>
        ...
        >
          ...
          <div class="links-grid">
            ...
            <label class="profile-field">
              ...
              <input
                v-model.trim="profile.links.twitch"
                class="profile-input"
                type="url"
            ...
            <label class="profile-field">
              ...
              <input
                v-model.trim="profile.links.youtube"
                class="profile-input"
                type="url"
            ...
            <label class="profile-field">
              ...
              <input
                v-model.trim="profile.links.tiktok"
                class="profile-input"
                type="url"
            ...
            <label class="profile-field">
              ...
              <input
                v-model.trim="profile.links.instagram"
                class="profile-input"
                type="url"
            ...
            <label class="profile-field full-width">
              ...
              <input
                v-model.trim="profile.links.website"
                class="profile-input"
                type="url"
                placeholder="https://..."
              >
        ...
        >
          <div class="profile-panel-heading">
            <div>
              ...
              <p>
                Choose a Project Respawn approved colour scheme for your creator card.
              </p>
            </div>
          </div>
          ...
          <div class="theme-grid">
            ...
            <button
              ...
              :class="[
                theme.key,
                {
                  selected: profile.theme === theme.key
                }
              ]"
        ...
        >
          <div class="profile-panel-heading">
            <div>
              ...
              <p>
                Control whether your creator identity can appear in Project Respawn discovery.
              </p>
            </div>
          </div>
          ...
          <div class="review-box">
            ...
            <div>
              ...
              <p>
                Creator controlled fields can be edited at any time.
                Featured status, ordering and moderation remain admin controlled.
              </p>
            </div>
      ...
      <aside
        id="creator-profile-preview"
        class="creator-profile-preview-panel"
      >
        ...
        <div class="preview-heading">
          <div>
            ...
            <p>
              This is how your card can appear on the Creators page.
            </p>
          </div>
        </div>
        ...
        >
          ...
          <div class="creator-card-chips">
            ...
            <span
              v-for="category in selectedCategoryDetails.slice(0, 5)"
              :key="category.key"
              :style="{
                '--category-accent': category.accent,
                '--category-accent-rgb': category.accentRgb
            ...
            >
              ...
              <CreatorCategoryIcon
                :name="category.icon"
                class="creator-card-category-icon"
              />
        ...
        <div class="preview-meta">
          ...
          <div>
            <span>Discovery</span>
            <strong>
              {{ profile.publicOptIn ? 'Enabled' : 'Hidden' }}
            </strong>
          </div>
    ...
    <section class="creator-profile-theme-strip">
      ...
      <div>
        <p class="creator-profile-eyebrow">
          Choose your card theme
        </p>

        <h2>
          Keep your identity. Stay part of Respawn.
        </h2>
      </div>
