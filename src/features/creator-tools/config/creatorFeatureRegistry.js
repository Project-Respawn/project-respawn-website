...
export const creatorFeatureRegistry = Object.freeze({
  ...
  community: { label: 'Community', routeName: 'CreatorCommunity', status: CREATOR_FEATURE_STATUS.PREVIEW },
  events: { label: 'Events', routeName: 'CreatorEvents', status: CREATOR_FEATURE_STATUS.PREVIEW },
  rewards: { label: 'Rewards', routeName: 'CreatorRewards', status: CREATOR_FEATURE_STATUS.PREVIEW },
  achievements: { label: 'Achievements', routeName: 'CreatorAchievements', status: CREATOR_FEATURE_STATUS.PREVIEW },
  members: { label: 'Members', routeName: 'CreatorMembers', status: CREATOR_FEATURE_STATUS.PREVIEW },
