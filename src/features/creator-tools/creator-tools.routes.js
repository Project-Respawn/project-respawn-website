...
export default [
  {
    ...
    children: [
      { path: '', name: 'CreatorDashboard', component: CreatorDashboard },
      { path: 'twitch', name: 'CreatorTwitch', component: TwitchOverview, alias: '/bot/twitch' },
      { path: 'discord', name: 'CreatorDiscord', component: CreatorDiscord, alias: '/bot/discord' },
      { path: 'bots', name: 'CreatorBots', component: BotsOverview, alias: '/bot' },
      { path: 'bots/twitch/commands', name: 'CreatorTwitchCommands', component: BasicCommands, alias: '/bot/twitch/commands' },
      { path: 'bots/twitch/alerts', name: 'CreatorTwitchAlerts', component: TwitchAlerts, alias: '/bot/twitch/alerts' },
      ...
      { path: 'overlays', name: 'CreatorOverlays', component: OverlayEntry, meta: { creatorFeature: 'overlays' } },
      { path: 'overlays/library', name: 'CreatorOverlayLibrary', component: OverlayManager, meta: { creatorFeature: 'overlays' } },
      ...
      { path: 'events', name: 'CreatorEvents', component: CreatorEvents },
      { path: 'members', name: 'CreatorMembers', component: CreatorMembers },
      { path: 'analytics', name: 'CreatorAnalytics', component: CreatorAnalytics },
      { path: 'integrations', name: 'CreatorIntegrations', component: Integrations, alias: '/bot/settings' },
      { path: 'setup', name: 'CreatorSetup', component: CreatorSetup },
    ],
  },
  {
    path: '/tts-overlay',
