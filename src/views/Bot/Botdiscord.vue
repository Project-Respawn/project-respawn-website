  ...
  <div class="bot-page">
    ...
    <main class="bot-main">
      <section class="hero-card">
        <div class="hero-copy">
          <p class="eyebrow">Discord tools</p>
          <h2>Discord dashboard coming soon</h2>
          <p class="hero-text">
            This page is reserved for Discord onboarding, permissions, moderation, and community tools.
          </p>
        </div>
...
.bot-page {
  ...
  min-height: 100vh;
  background:
    radial-gradient(circle at top left, rgba(88, 101, 242, 0.16), transparent 22%),
