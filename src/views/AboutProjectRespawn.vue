...
import BrandsRewards from './tabs/BrandsRewards.vue';
...
const tabConfig = [
  ...
  {
    id: 'brands',
    label: 'Brands & Rewards',
    shortLabel: 'Brands',
    icon: '✦',
    component: BrandsRewards,
    kicker: 'A performance-based brand trial',
    lead: 'Run a six-month direct affiliate trial with no upfront marketplace listing or media fee. Members use earned Respawn Tokens to unlock your genuine benefit, and you pay an agreed commission when verified sales are generated.',
    cardLabel: 'THE SIX-MONTH PROPOSITION',
    cardTitle: 'Low upfront risk. A stronger reason to choose.',
    cardCopy: 'Test whether an earned reward can turn attention into preference, attributed sales and a reason for members to return to your brand.',
    path: ['Offer', 'Measure', 'Learn'],
    primary: { label: 'Discuss a six-month trial', to: '/contact' },
    secondary: { label: 'See all partners', to: { path: '/about', query: { tab: 'partners' } } }
  },
  {
    id: 'research',
...
export default {
  name: 'About',
  components: { AboutProjectRespawn, OurVision, GameDevelopers, Partners, BrandsRewards, ResearchImpact },
  setup() {
