<template>
  <main class="container py-5">
    <section>
      <h1 class="mb-4">About Project Respawn</h1>      
        ...
        <p>That is why we don't just fix the old you. We help you build the new you.</p>
      ...
      <div class="mt-5">
        <router-link to="/contact" class="btn btn-primary btn-lg">Join the Community</router-link>
      </div>
    </section>
  </main>
</template>
