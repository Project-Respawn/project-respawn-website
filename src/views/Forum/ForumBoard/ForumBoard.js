...
export default {
    ...
    computed: {
        board() {
            ...
            return {
                ...
                rules: getBoardRules(this.boardRecord.slug),
                tags: getBoardTags(this.boardRecord.slug),
        ...
        scrollingFeaturedThreads() {
            if (this.featuredThreadsForBoard.length <= 1) {
                return [
        ...
        hasModerationAccess() {
            return canManageForum(this.currentUser);
        },
    ...
    methods: {
        ...
        async loadCurrentUser() {
            this.currentUser = await getCurrentForumUser();
        },

        async loadBoard() {
            const page = await getBoardPage(this.boardSlug);

            this.boardRecord = page.board;
            this.boardCategory = page.category;
            this.boardThreads = page.threads;
            this.boardPosts = page.posts;
        },
