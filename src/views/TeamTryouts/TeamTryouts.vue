    ...
    <section class="content-section alt-surface">
      <div class="container narrow">
        ...
        <ul class="bullet-list">
          <li>Set up custom Twitch and Discord bot messaging.</li>
          <li>Configure community welcomes and go-live announcements.</li>
      ...
      <div class="container">
        ...
        <div class="steps-grid">
          <article class="step-card">
            ...
            <h3>Apply</h3>
            <p>Apply to join as a streamer partner through our application process.</p>
          </article>
          <article class="step-card">
            <span class="step-number">02</span>
            <h3>Get onboarded</h3>
            <p>If accepted, we help connect your Twitch and Discord setup and onboard you into Project Respawn.</p>
          </article>
          <article class="step-card">
      ...
      <div class="container">
        ...
        <div class="partner-columns">
          <article class="partner-card">
            ...
            <p class="track-summary">If your content is driven by performance, improvement, and competition, this is likely the right path for you.</p>
          </article>
          ...
          <article class="partner-card">
            ...
            <p class="track-summary">If your content is driven by community, conversation, and helping people feel braver in and out of chat, this is likely the right path for you.</p>
          </article>
        </div>
      ...
      <div class="container narrow">
        ...
        <details class="faq-item">
          ...
          <p>
            ...
            We don’t plan to charge creators for these tools.
          </p>
        </details>

        <details class="faq-item">
          <summary>Do I need a Discord server to apply?</summary>
          <p>
        ...
        <details class="faq-item">
          <summary>Is Project Respawn finished?</summary>
          <p>
        ...
        <details class="faq-item">
          <summary>Can I apply for both competitive and social confidence tracks?</summary>
          <p>
        ...
        <details class="faq-item">
          <summary>Will I get paid as a partner?</summary>
          <p>
            There are no guaranteed payments at this stage. Our long-term goal is to build an engagement-based model where,
            if campaigns and partnerships generate value through Project Respawn, that value can be shared with the creators and communities who drive it.
          </p>
        </details>
      </div>
    </section>
