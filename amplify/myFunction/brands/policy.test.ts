...
assert.equal(isPlatformBrandOperator(['Staff']), true)
assert.equal(isPlatformBrandOperator(['Member']), false)
...
assert.doesNotThrow(() => assertCanChangeBrandOwner(isPlatformBrandOperator(['Staff'])))
