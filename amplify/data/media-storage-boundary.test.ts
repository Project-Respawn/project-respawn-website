...
const mediaStart = schema.search(/\bMediaItem:\s*a\s*\.model/)
const mediaEnd = schema.indexOf('MerchProductImage: a', mediaStart)
assert.ok(mediaStart >= 0 && mediaEnd > mediaStart, 'media storage boundaries must be found')
