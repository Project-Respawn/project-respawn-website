// 1. Imports and schema container
...
const schema = a.schema({
  // =========================================================================
  // 2. Admin user types and operations
  // =========================================================================
  ...
  Event: a
    .model({
      ...
      // Optional brand associated with the event
      brandId: a.id(),
  ...
  // =========================================================================
  // 6. Forum types, models, and mutations
  // =========================================================================
  ...
  // =========================================================================
  // 7. Core merch taxonomy (Brand, MerchCategory)
  // =========================================================================
  ...
  Brand: a
    .model({
      ...
      // Inverse relationships for belongsTo references
  ...
  // =========================================================================
  // 8. Merch models (products, images, variants, links)
  // =========================================================================
  ...
  MerchProductImage: a
    .model({
      ...
      // Flags used by the media editor
      isVisible: a.boolean(),
      isFeatured: a.boolean(),
  ...
  // =========================================================================
  // 9. Brand access (unified brand/host access)
  // =========================================================================
  ...
  BrandAccess: a
    .model({
      ...
      accessLevel: a.string().required(), // e.g. "owner", "manager", "editor"
      assignedBy: a.string(),
...
// 10. Data resource and authorization modes
