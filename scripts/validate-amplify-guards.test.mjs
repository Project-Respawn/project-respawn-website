...
import { validateEnvironmentDescriptor } from './lib/local-amplify-environment.mjs'
...
const descriptor = (poolStackName = `${sandbox('current')}-auth123-A`, apiStackName = `${sandbox('current')}-data123-B`, type = 'sandbox') => ({
