...
NAMESPACE = "ProjectRespawn/TwitchRuntime"
DIMENSIONS = [
    {"Name": "Environment", "Value": "Ntgrestage8"},
    {"Name": "Service", "Value": os.environ["SERVICE_NAME"]},
]
...
def handler(event, _context):
    ...
    item = dynamodb.get_item(
        TableName=os.environ["HEARTBEAT_TABLE_NAME"],
        Key={"integrationId": {"S": os.environ["INTEGRATION_ID"]}},
        ProjectionExpression="lastBotHeartbeatAt",
    ).get("Item")
